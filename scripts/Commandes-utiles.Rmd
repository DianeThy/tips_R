...
# `r fontawesome::fa("table", fill = "#0000CC")` <FONT COLOR="#0000CC">Manipulations de variables</FONT>
...
# `r fontawesome::fa("database", fill = "#0000CC")` <FONT COLOR="#0000CC">Manipulations de dataframes</FONT>
...
# `r fontawesome::fa("chart-line", fill = "#0000CC")` <FONT COLOR="#0000CC">Analyse</FONT>
...
data |> 
  ...
  gt_plt_bar_pct(`% temps`, scaled = TRUE, labels=TRUE, decimals = 0, 
...
# `r fontawesome::fa("markdown", fill = "#0000CC")` <FONT COLOR="#0000CC">R Markdown</FONT>
...
```{r echo=TRUE, eval=FALSE}
<p align="center">
 <img src="../figures/graĥique.png" width = "110">
</p>
```
...
# `r fontawesome::fa("github", fill = "#0000CC")` <FONT COLOR="#0000CC">Git</FONT>
...
# `r fontawesome::fa("box-archive", fill = "#0000CC")` <FONT COLOR="#0000CC">Autre</FONT>
